      ...
      for (BasicBlock::iterator ii = bb->begin(), ie = bb->end(); ii != ie; ++ii)
      {
        ...
        if (gating->is_gating_function(f_target))
        {
          ...
          for (auto tmp_ci : cis)
          {
            ...
            {
              // direct call
              if (f_callee->getName().find("llvm.") == StringRef::npos && !is_skip_function(f_callee->getName()) && f_callee->getName().find("ioctl") == StringRef::npos && f_callee->getName().find("lock") == StringRef::npos)
              {
            ...
            else
            {
              ...
              {
                if (f_indirect_callee->getName().find("llvm.") == StringRef::npos && !is_skip_function(f_indirect_callee->getName()) && f_indirect_callee->getName().find("ioctl") == StringRef::npos && f_indirect_callee->getName().find("lock") == StringRef::npos)
                {
